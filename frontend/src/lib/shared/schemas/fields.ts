...
export const passwordField = (t: TranslationFunctions) =>
  z
    .string()
...
export const emailField = (t: TranslationFunctions) =>
  z.string().email(t.errors.invalid_email());

export const nameField = (t: TranslationFunctions) =>
  lengthString(t, "Name", 3, 50);
